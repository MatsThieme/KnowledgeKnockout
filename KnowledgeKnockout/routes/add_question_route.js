...
function add_question_route_post(req, res) {
    ...
    let topicId = parseInt(req.body.topicId);
    let topicBlockId = parseInt(req.body.topicBlockId);
    let lastQuestionId = 0;
    let sql = 'insert into question (content, blockId, topicId) values (?, ?, ?)';
    let inserts = [questionContent, topicBlockId.toString(), topicId.toString()];
